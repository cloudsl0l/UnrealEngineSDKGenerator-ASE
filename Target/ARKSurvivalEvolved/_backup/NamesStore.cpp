...
{
	constexpr std::uintptr_t offset = 0x2292504;

	GlobalNames = reinterpret_cast<decltype(GlobalNames)>(
		reinterpret_cast<std::uintptr_t>(GetModuleHandleW(nullptr)) + offset
		);
